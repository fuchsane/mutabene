...
public class UserController implements IEntityUseController<UserModel, Long, ModelMap, String, BindingResult> {
    ...
    private Map<String,String> getListCenters(){
    ...
    private Map<String,String> getListRoles(){
    ...
    public String add(UserModel formModel, ModelMap m) {
        ...
        m.addAttribute("listCenters", getListCenters());       
        m.addAttribute("listRoles", getListRoles());       
